...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { country1_goals: @prediction.country1_goals, country1_id: @prediction.country1_id, country2_goals: @prediction.country2_goals, country2_id: @prediction.country2_id, game_id: @prediction.game_id }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { country1_goals: @prediction.country1_goals, country1_id: @prediction.country1_id, country2_goals: @prediction.country2_goals, country2_id: @prediction.country2_id, game_id: @prediction.game_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
