class PredictionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prediction.save
        format.html { redirect_to user_path(@prediction.user), notice: 'Prediction was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @prediction.update(prediction_params)
        format.html { redirect_to user_path(@prediction.user), notice: 'Prediction was successfully updated.' }
  ...
  private
    ...
    def prediction_params
      params.require(:prediction).permit(:game_id, :country1_id, :country2_id, :country1_goals, :country2_goals)
    end
end
